...
function TokenChart(){
    ...
    return (
        ...
        <div className="token_chart_header">
            <div className="token_chart_header_title">
                Chart
            </div>
            <div className="token_chart_header_btns">
                <div className="token_chart_header_btns_wrap">
                    <div className="token_chart_header_btn">
                        Standard
                    </div>
                    <div className="token_chart_header_btn token_chart_header_btn_active">
                        TradingView
                    </div>
                    <div className="token_chart_header_btn">
                        Depth
                ...
                <div className="token_chart_header_btns_helper">
                    <div className="token_chart_header_btns_help token_chart_header_btns_helper_grid">
                        <img src="img/grid.svg" alt=""/>
                    </div>
                    <div className="token_chart_header_btns_help token_chart_header_btns_helper_full">
