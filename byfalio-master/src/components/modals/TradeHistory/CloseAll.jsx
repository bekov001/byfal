            ...
            <div className="trade_modal_w close_all_modal_w">
                <div className="close_all_modal_main">
                    ...
                    <div className="trade_modal_main_btns">
                        <div onClick={cancelAllShowSet} className="trade_modal_main_btn_v2 trade_modal_main_btn_ok">
                            Ок
                        </div>
                        <div onClick={cancelAllShowSet} className="trade_modal_main_btn_v2 trade_modal_main_btn_cancel">
                            Отмена
                        </div>
                    </div>
                </div>
