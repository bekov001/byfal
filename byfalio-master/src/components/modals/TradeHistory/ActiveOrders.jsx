...
import CloseWith from './CloseWith';
import Pnl from './Pnl';
...
function ActiveOrders({tradeHistoryActiveOrdersShow}){
    ...
    return (
        ...
        <div className="active_order_sort">
            <div className="active_order_sort_column mr25">
                <span>Все контакты</span>
                <img src="img/select2.svg" alt=""/>
            </div>
            <div className="active_order_sort_column mr40">
                <span>Все типы</span>
                <img src="img/select2.svg" alt=""/>
            </div>
            <div onClick={() => setCancelAllShow(true)} className="active_order_sort_btn">
                Отменить все
            </div>
        </div>
        <div className="history_main_row_w">
            ...
            <div className="history_main_row_column df">
                ...
                <div className="active_order_pnl_wrap">
                    <div className="active_order_pnl_row">
                        ...
                        <img onClick={() => setPnlShow(true)} src="img/link.svg" alt=""/>
                    </div>
        ...
        <div className="active_order_close_w border_none">
            <div onClick={() => setCancelAllShow(true)} className="history_main_row_close_all_btn active_order_close_all">
                Закрыть все сделки
            </div>
        </div>
